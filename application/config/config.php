...
|
*/
$config['base_url'] = rtrim(getenv('APP_BASE_URL') ?: 'http://localhost/koi-pond-iot-monitoring', '/') . '/';
...
$config['cookie_path']		= '/';
$config['cookie_secure']	= filter_var(getenv('APP_COOKIE_SECURE') ?: FALSE, FILTER_VALIDATE_BOOLEAN);
